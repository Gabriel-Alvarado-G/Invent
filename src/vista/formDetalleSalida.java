...
public class formDetalleSalida extends javax.swing.JPanel {
    ...
    public formDetalleSalida(Usuario user) {
        initComponents();
        this.sysUser = user;
        getEntradas();   
    }
    public static void getEntradas(){
        ...
        List<DetalleSalida> entrada = entraDAO.consultar();

        DefaultTableModel model = (DefaultTableModel) tabListaEntradas.getModel();
        tabListaEntradas.removeAll();
        model.setRowCount(0);
        
        for(DetalleSalida dtas :entrada){
            
            model.addRow(new String[]{String.valueOf(dtas.getIdDetalleSalidaProducto()), String.valueOf(dtas.getIdSalidaProducto()),  String.valueOf(dtas.getIdProducto()), 
                String.valueOf(dtas.getSubtotal()), String.valueOf(dtas.getValorIva()), String.valueOf(dtas.getValorDescuento()), String.valueOf(dtas.getTotal())
            });
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DETALLE SALIDA");
        ...
        tabListaEntradas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "IdSalida Producto", "IdProducto", "Subtotal", "Iva", "Total"
            }
        ));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        DetalleSalidaDAO cliDAO = new DetalleSalidaDAO();
        ...
        if(fila >= 0){
            ...
            if(res == 0){
                entra.setIdDetalleSalidaProducto(Integer.valueOf(id));
                entra.setEstado(0);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        formDetalleSalidaAdd entra = new formDetalleSalidaAdd(sysUser);
...
//formEntradaAdd regClient = new formEntradaAdd(sysUser);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(fila >= 0){
            String id = (String) tabListaEntradas.getValueAt(fila, 0);
            formDetalleSalidaEdit editClient = new formDetalleSalidaEdit(id, sysUser);
