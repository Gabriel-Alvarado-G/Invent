 ...
 * @author Jonathan
 */
public class formDetalleSalidaAdd extends javax.swing.JFrame {
     ...
     */
    public formDetalleSalidaAdd() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public formDetalleSalidaAdd(Usuario user) {
        initComponents();
        this.sysUser = user;
        this.setLocationRelativeTo(null);
        this.getPorcentaje();
    ...
    private void initComponents() {
        ...
        labTitle.setText("Registrar Detalle Salida");
        ...
        panMain.add(txtSubTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 180, 30));
        ...
        labIdentrada.setText("ID Salida");
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        DetalleSalida entrada1 = new DetalleSalida();
       DetalleSalidaDAO EntraDAO = new DetalleSalidaDAO();
        
        if( !txtSubTotal.getText().equals("") &&
                !txtTotal.getText().equals("") ){
            
            entrada1.setIdSalidaProducto(String.valueOf(jtxentrada.getItemAt(jtxentrada.getSelectedIndex()).getIdSalidaProducto()));
                ...
                if(entrada1.getIdProducto().length() >= 1){
                    if(entrada1.getIdProducto().length() <= 11){
                       ...
                       entrada1.setEstado(1);
                        ...
                        entrada1.setUsuarioIngreso(sysUser.getUsername());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formDetalleSalidaAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formDetalleSalidaAdd().setVisible(true);
            }
        });
    }
