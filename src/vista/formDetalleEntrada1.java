...
public class formDetalleEntrada1 extends javax.swing.JPanel {
     ...
     */
    public formDetalleEntrada1() {
        initComponents();
        
    }
    
    public formDetalleEntrada1(Usuario user) {
        initComponents();
        this.sysUser = user;
        getEntradas();   
    }
    public static void getEntradas(){
        ...
        List<DetalleEntrada> entrada = entraDAO.consultar();

        DefaultTableModel model = (DefaultTableModel) tabListaEntradas.getModel();
        tabListaEntradas.removeAll();
        model.setRowCount(0);
        
        for(DetalleEntrada ent :entrada){
            
            model.addRow(new String[]{String.valueOf(ent.getIdDetalleEntradaProducto()), String.valueOf(ent.getIdEntradaProducto()) , String.valueOf(ent.getIdProducto()), 
                String.valueOf(ent.getSubtotal()), String.valueOf(ent.getValorIva()), String.valueOf(ent.getValorDescuento()), String.valueOf(ent.getTotal())
            });
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DETALLE ENTRADA");
        ...
        tabListaEntradas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "IdEntrada Producto", "IdProducto", "Subtotal", "Iva", "Total"
            }
        ));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        DetalleEntradaDAO cliDAO = new DetalleEntradaDAO();
        ...
        if(fila >= 0){
            ...
            if(res == 0){
                entra.setIdDetalleEntradaProducto(Integer.valueOf(id));
                entra.setEstado(0);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        formDetalleEntradaAdd entra = new formDetalleEntradaAdd(sysUser);
...
//formEntradaAdd regClient = new formEntradaAdd(sysUser);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(fila >= 0){
            String id = (String) tabListaEntradas.getValueAt(fila, 0);
            formDetalleEntradaEdit editClient = new formDetalleEntradaEdit(id, sysUser);
