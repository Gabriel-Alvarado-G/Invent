...
public class formIventario1 extends javax.swing.JPanel {
     ...
     */
    public formIventario1() {
        initComponents();
        
    }
    
    public formIventario1(Usuario user) {
        initComponents();
        this.sysUser = user;
        getEntradas();   
    }
    ...
    private void initComponents() {
        ...
        tabListaEntradas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre Producto", "Precio", "Total Ingreso", "Total Salida", "Total"
            }
        ));
